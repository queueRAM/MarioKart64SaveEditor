...
namespace MarioKart64SaveEditor
{
   ...
   class BE
   {
      public static UInt32 U32(byte[] buf, int i)
      {
      ...
      public static Int32 I32(byte[] buf, int i)
      {
      ...
      public static UInt16 U16(byte[] buf, int i)
      {
      ...
      public static Int16 I16(byte[] buf, int i)
      {
   ...
   // helper class for converting arrays of bytes in little endian to native integer types
   class LE
   {
      public static UInt32 U32(byte[] buf, int i)
      {
